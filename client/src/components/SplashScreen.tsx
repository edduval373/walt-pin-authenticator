...
export default function SplashScreen({ onComplete }: SplashScreenProps) {
  ...
  return (
    <motion.div 
      ...
      exit={{ opacity: 0 }}
    >
      <div className="text-center px-4 max-w-sm w-full py-2 min-h-screen flex flex-col" style={{ paddingTop: '0px', transform: 'translateY(-115px)' }}>
        ...
        {/* Text content */}
        <div className="flex-1 flex flex-col justify-start" style={{ transform: 'translateY(-151px)' }}>
          {/* Tagline */}
          <motion.div
        ...
        {/* Bottom Section */}
        <div className="flex-shrink-0" style={{ transform: 'translateY(-151px)' }}>
